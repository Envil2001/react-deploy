    ...
    .filter((item) => item.title.toLowerCase().includes(searchInput.toLowerCase())).map((item) => {
        ...
        return (
          <AppContext.Provider
            ...
            <Routes>
                <Route exact path="/react-deploy/" element={
                ...
                <Route path="/react-deploy/products/:id" element={<Details 
                    onAdd={(obj) => onAddToCart(obj)}
                />}/>
                <Route path="*" element={<NotFound />}/>
                <Route path="/react-deploy/login" element={<LoginPage />}/>
                <Route path="/react-deploy/register" element={<RegisterPage />}/>
            </Routes> 
            </div>
          </AppContext.Provider>
        )
